...
const Services = () => {
    ...
    function getServices() {
        axios.get('http://localhost:80/api/services.php/')
            .then(function (response) {
                ...
                setOriginalServices(response.data); // Store original data
            });
    }
    ...
    useEffect(() => {
        console.log("serviceIdToEdit:", serviceIdToEdit);
        ...
        <div className='container mt-4'>
            ...
            <div className="table-responsive">
                <table className="table table-striped table-hover custom-table" style={{ width: '100%' }}>
                    <thead>
                        <tr>
                            <th className="col text-center" onClick={() => handleSort('id')}>
                                #
                                {getSortIcon('id')}
                            </th>
                    ...
                    <tbody>
                        {currentServices.map((service, key) =>
                            <tr key={key}>
                                <td className="col text-center">{service.id}</td>
    ...
    {/* Only show edit and delete buttons if the user is not an admin */}
    {userRole !== '1' && (
        <>
